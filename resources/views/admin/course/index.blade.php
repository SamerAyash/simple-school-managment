                                    ...
                                    @foreach($courses as $course)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="{{route('course.destroy',[$course->id])}}" class="btn btn-outline-danger deleteForm{{$course->id}}" onclick="confirmDeleted({{$course->id}})">
                                                    @csrf
                                                    @method('delete')
    ...
    <script>
        function confirmDeleted(id){
            ...
            swalWithBootstrapButtons.fire({
                title: 'Are you sure ?!',
                text: "You are delete the course",
                icon: 'warning',
