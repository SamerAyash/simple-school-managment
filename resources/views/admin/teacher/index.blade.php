                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="symbol symbol-150 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                                    <div class="symbol-label" style="background-image: url('{{$teacher->image_url}}')">
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="{{route('teacher.destroy',[$teacher->id])}}" class="btn btn-outline-danger deleteForm{{$teacher->id}}" onclick="confirmDeleted({{$teacher->id}})">
                                                    @csrf
                                                    @method('delete')
