    ...
    <div class="login login-4 login-forgot-on d-flex flex-row-fluid" id="kt_login">
        <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url({{asset('/assets/media/bg/bg-5.jpg')}});">
            ...
            <div class="login-form text-center p-7 position-relative overflow-hidden">
                ...
                <div class="login-forgot text-white font-weight-bold">
                    <div class="mb-10">
                        <h3>Reset Password</h3>
                        <div class="text-white font-weight-bold">Enter your new password</div>
                    </div>
                    @if($errors->all())
                    ...
                    <form  action="{{route('admin.updatePassword',['token'=>$data->token])}}" method="post" class="form" id="kt_login_forgot_form">
                        @csrf
                        <div class="form-group mb-10">
                            <input class="form-control form-control-solid h-auto py-4 px-8 mb-3" type="password" placeholder="New password" name="password"/>
                            <input class="form-control form-control-solid h-auto py-4 px-8" type="password" placeholder="Confirm new password" name="password_confirmation"/>
                        </div>
                        <div class="form-group d-flex flex-wrap flex-center mt-10">
                            ...
                            <a href="{{route('admin.login')}}" id="kt_login_forgot_cancel"
                               class="btn btn-light-primary font-weight-bold px-9 py-4 my-3 mx-2">Go to Sign in</a>
                        </div>
                    </form>
                </div>
